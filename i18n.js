...
const I18N = {
  en: {
    ...
    stopBtn: 'Stop',
    debugH2: '🐛 Debug info',
    debugHint: "Shows up automatically when something fails in a way that needs the developer's help. Select all the text below and paste/send it — no need to find a downloaded file.",
    clearDebugBtn: 'Clear',
  ...
  zh: {
    ...
    stopBtn: '停止',
    debugH2: '🐛 调试信息',
    debugHint: '出现需要开发者帮忙看一下的问题时,这里会自动出现内容——全选下面这段文字,直接复制粘贴发过来就行,不用去找什么下载的文件。',
    clearDebugBtn: '清除',
